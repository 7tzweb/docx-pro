...
/* כל משאבי TinyMCE במקום אחד (side-effect imports) */
...
/**
 * קומפוננטת RTE לשימוש חוזר (App + ProjectModal)
 */
export default function RichTextEditor({ value, onChange, rtl = true, height = 720 }) {
  return (
    <Editor
      value={value}
